...
flowchart TD
    subgraph "Phase 1: Cognitive Primitives"
        A[Financial Data] --> B[Hypergraph Encoding]
        B --> C[Cognitive Primitives Registry]
    end
    
    subgraph "Phase 2: ECAN Attention"
        C --> D[STI/LTI Allocation]
        D --> E[Attention Economics]
    end
    
    subgraph "Phase 3: Neural-Symbolic"
        E --> F[Custom ggml Kernels]
        F --> G[Symbolic Tensor Ops]
    end
    
    subgraph "Phase 4: Distributed Mesh"
        G --> H[REST/WebSocket APIs]
        H --> I[Embodiment Layer]
    end
    
    subgraph "Phase 5: Meta-Cognition"
        I --> J[Self-Analysis]
        J --> K[Evolutionary Optimization]
    end
    
    subgraph "Phase 6: Unified System"
        K --> L[Cognitive Unity]
        L --> M[Emergent Intelligence]
    end
